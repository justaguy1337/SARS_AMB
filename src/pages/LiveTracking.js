...
const LiveTracking = () => {
  ...
  const initializeTracking = () => {
    ...
    const ambulanceStart = { lat: 28.6050, lng: 77.2150 };
    ...
    map.on('load', () => {
      ...
      const ambulanceMarker = new window.tt.Marker({ element: ambulanceMarkerElement })
  ...
  const updateAmbulancePosition = () => {
    setAmbulancePosition(prev => {
      ...
      const targetLat = 28.6200;
      const targetLng = 77.2100;
      ...
      if (trackingMap && trackingMap.ambulanceMarker) {
        trackingMap.ambulanceMarker.setLngLat([newLng, newLat]);
      }
  ...
  const updateMetrics = () => {
    ...
    setSpeed(prev => 35 + Math.random() * 20);
    ...
    setSpeedData(prev => {
      ...
      const newTime = `${min}:${String(sec + 30).padStart(2, '0')}`;
      newData.push({ time: newTime, speed: 35 + Math.random() * 20 });
      ...
      >
        ...
        <Grid container spacing={2.5} sx={{ px: 2 }}>
                ...
                <Card sx={{ 
                  ...
                  <CardContent sx={{ p: 2.5 }}>
                    <Box display="flex" alignItems="center" justifyContent="space-between">
                      <Box>
                        <Typography variant="caption" sx={{ opacity: 0.9, textTransform: 'uppercase', letterSpacing: 0.5, fontWeight: 600 }}>
                          ETA
                        </Typography>
          ...
          <Grid item xs={12} lg={10}>
            {/* Live Map */}
            <Paper elevation={3} sx={{ mb: 2.5, overflow: 'hidden', borderRadius: 2, border: '1px solid #e5e7eb' }}>
              <Box sx={{ 
                p: 2, 
              ...
              <Box 
                ...
                sx={{ width: '100%', height: 550, bgcolor: '#e5e7eb', position: 'relative' }} 
              />
            ...
            <Grid container spacing={2.5}>
              <Grid item xs={12} md={6}>
                <Paper elevation={3} sx={{ p: 2.5, borderRadius: 2, border: '1px solid #e5e7eb', height: '100%' }}>
                ...
                <Paper elevation={3} sx={{ p: 2.5, borderRadius: 2, border: '1px solid #e5e7eb', height: '100%' }}>
                  <Box display="flex" alignItems="center" mb={1.5}>
                    <Box sx={{ 
                      ...
                      <Traffic sx={{ color: '#f59e0b', fontSize: 20 }} />
                    </Box>
                    <Box>
                      <Typography variant="subtitle1" fontWeight={700} color="text.primary">
                        Traffic Analysis
                  ...
                  <ResponsiveContainer width="100%" height={180}>
                    <AreaChart data={trafficData}>
                      <CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" />
                      <XAxis dataKey="segment" stroke="#6b7280" style={{ fontSize: 10 }} />
                      <YAxis stroke="#6b7280" style={{ fontSize: 10 }} />
                      <Tooltip 
                        contentStyle={{ 
                          backgroundColor: 'white', 
          ...
          <Grid item xs={12} lg={2}>
            {/* Weather Card */}
            <Paper elevation={3} sx={{ p: 2.5, mb: 2.5, borderRadius: 2, border: '1px solid #e5e7eb', background: 'linear-gradient(135deg, #667eea15 0%, #764ba215 100%)' }}>
              ...
              <Box display="flex" alignItems="center" mb={2} sx={{ bgcolor: 'white', p: 2, borderRadius: 2 }}>
              ...
              <Grid container spacing={1.5}>
                {[
                  { icon: <Opacity />, label: 'Humidity', value: `${weather.humidity}%`, color: '#3b82f6' },
                  { icon: <Air />, label: 'Wind', value: `${weather.windSpeed} km/h`, color: '#10b981' },
                  { icon: <Visibility />, label: 'Visibility', value: `${weather.visibility} km`, color: '#f59e0b' },
                  { icon: <WbSunny />, label: 'Rain', value: `${weather.precipitation}%`, color: '#ef4444' }
                ].map((item, index) => (
                  <Grid item xs={6} key={index}>
                    <Box sx={{ bgcolor: 'white', p: 1.5, borderRadius: 1.5, display: 'flex', alignItems: 'center' }}>
                      ...
                      <Box>
                        ...
                        <Typography variant="body2" fontWeight={700} color="text.primary" sx={{ fontSize: '0.875rem' }}>
                          {item.value}
                        </Typography>
                      </Box>
                    </Box>
            ...
            {/* ETA Prediction */}
            <Paper elevation={3} sx={{ p: 2.5, mb: 2.5, borderRadius: 2, border: '1px solid #e5e7eb' }}>
              <Box display="flex" alignItems="center" mb={1.5}>
                <Box sx={{ 
                  width: 36, 
                  height: 36, 
              ...
              <ResponsiveContainer width="100%" height={160}>
                <LineChart data={etaData}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" />
                  <XAxis dataKey="time" stroke="#6b7280" style={{ fontSize: 9 }} />
            ...
            {/* Response Breakdown */}
            <Paper elevation={3} sx={{ p: 2.5, borderRadius: 2, border: '1px solid #e5e7eb' }}>
              <Box display="flex" alignItems="center" mb={1.5}>
                <Box sx={{ 
                  width: 36, 
                  height: 36, 
